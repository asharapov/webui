...
public interface UIContext extends RequestContext {
     ...
     * @param viewId  идентификатор формы с которой должна быть ассоциирована создаваемая копия контекста.
     * @param rank  ранг формы, используется в случае когда данная форма ранее отсутствовала в менеджере состояний.
     *              Влияет на то когда данное состояние должно было быть удалено или менеджера состояний.
     */
    ...
    /**
     * Возвращает ссылку на символьный поток данных передающий данные непосредственно клиенту.
