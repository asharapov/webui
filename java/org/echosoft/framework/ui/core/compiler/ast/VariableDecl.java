 ...
 */
public final class VariableDecl extends ASTNode {

    private String name;
    private int arrayDimension;
    private Expression initValue;

    public VariableDecl(final String name) {
        this.name = name;
        this.arrayDimension = 0;
    }
    public VariableDecl(final String name, final int arrayDimension) {
        this.name = name;
        this.arrayDimension = arrayDimension;
    }

    public VariableDecl(final String name, final Expression initValue) {
        this.name = name;
    ...
    public VariableDecl(final String name, final int arrayDimension, final Expression initValue) {
        this.name = name;
        this.arrayDimension = arrayDimension;
        this.initValue = initValue;
        if (initValue!=null)
     ...
     */
    public void setInitValue(final Expression initValue) {
        this.initValue = initValue;
        if (initValue!=null)
            initValue.setParent(this);
    }
