 ...
 * @author Julio Vilmar Gesser
 */
public final class ASTInitializerDecl extends ASTBodyDecl {

    private boolean isStatic;
    private ASTBlockStmt block;

    public ASTInitializerDecl(final boolean isStatic) {
        super();
    ...
    public void setBlock(final ASTBlockStmt block) {
        this.block = block;
        if (block!=null)
            block.setParent( this );
    }
