 ...
 */
public abstract class ASTTypeDecl extends ASTBodyDecl {

    private int modifiers;
    private String name;
    private List<ASTBodyDecl> members;

    public ASTTypeDecl(final int modifiers, final String name) {
     ...
     */
    public Iterable<ASTBodyDecl> getMembers() {
        return members!=null ? members : Collections.<ASTBodyDecl>emptyList();
    }
     ...
     */
    public <T extends ASTBodyDecl> T addMember(final T member) {
        if (members==null)
            this.members = new ArrayList<ASTBodyDecl>(2);
