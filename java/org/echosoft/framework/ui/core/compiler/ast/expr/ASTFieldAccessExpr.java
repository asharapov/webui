 ...
 */
public final class ASTFieldAccessExpr extends ASTExpression {

    private ASTExpression scope;
    private String field;

    public ASTFieldAccessExpr() {
    }

    public ASTFieldAccessExpr(final ASTExpression scope, final String field) {
        this.scope = scope;
        this.field = field;
        if (scope!=null)
