 ...
 */
public final class ASTExplicitConstructorInvocationStmt extends ASTStatement {

    private boolean isThis;
    private ASTExpression classExpr;
    private List<ASTExpression> args;

    public ASTExplicitConstructorInvocationStmt(final boolean isThis) {
        this.isThis = isThis;
    }
    ...
    public ASTExpression getClassExpr() {
        return classExpr;
    }
    public <T extends ASTExpression> T setClassExpr(final T classExpr) {
    ...
    public <T extends ASTExpression> T addArgument(final T argument) {
        if (args==null)
