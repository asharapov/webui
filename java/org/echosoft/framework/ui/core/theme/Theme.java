...
public interface Theme {
     ...
     * Возвращает значение указанного в аргументе свойства темы.
     * @param key  идентификатор свойства темы.
     * @param defaultValue  значение по умолчанию, используемое в том случае когда указанное в первом аргументе свойство не было установлено для данной темы.
    ...
    /**
     * Возвращает упорядоченный список URL тех javascript файлов темы которые должны быть подключены на
     * <strong>каждую</strong> страницу приложения в первую очередь.
     * @return упорядоченный список ссылок на те javascript файлы темы,
     *  которые должны быть подключены на каждой странице приложения в <strong>первую</strong> очередь.
     */
    public String[] getGlobalJS1Files();

    /**
     * Возвращает упорядоченный список URL тех javascript файлов темы которые должны быть подключены на
     * <strong>каждую</strong> страницу приложения в последнюю очередь.
     * @return упорядоченный список ссылок на те javascript файлы темы,
     *  которые должны быть подключены на каждой странице приложения в <strong>последнюю</strong> очередь.
     */
    ...
    /**
     * Возвращает ссылку на поток из которого можно прочитать содержимое затребованного ресурса темы.
     * @param key  некоторый логический путь до требуемого ресурса относительно корневого каталога данной темы..
